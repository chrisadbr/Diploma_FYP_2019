...
<body>
    ...
    ?>
     <div class="book_container">
         <div class="img">
            <img src="../Book_Cover/book8.jpg" alt="">
            <a href="../Books/download.php?id=<?php echo $row['id'] + 8;?>">
...
<div class="_container">
        <table align = "center">
            ...
            <tbody>
                <?php
                    $query = 'SELECT * FROM anonymousBrowsing';
                    $stm = $conn->prepare("select * from anonymousBrowsing");
                    $stm -> execute();
                    while($row = $stm->fetch()){       
                ?>
                <tr>
