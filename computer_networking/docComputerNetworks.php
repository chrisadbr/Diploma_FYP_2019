...
<div class="log-bar">
    ...
    ?>
     <div class="book_container">
         <div class="img">
            <img src="../Book_Cover/book7.jpeg" alt="">
            <a href="../Books/download.php?id=<?php echo $row['id'] + 7;?>">
...
<div class="_container">
        <table align = "center">
            ...
            <tbody>
                <?php
                    $query = 'SELECT * FROM computer_networks';
                    $stm = $conn->prepare("select * from computer_networks");
                    $stm -> execute();
                    while($row = $stm->fetch()){
