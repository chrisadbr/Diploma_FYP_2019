...
<div class="log-bar">
    ...
    ?>
     <div class="book_container">
         <div class="img">
            <img src="../Book_Cover/book9.jpg" alt="">
            <a href="../Books/download.php?id=<?php echo $row['id'] + 9;?>">
...
<div class="_container">
        <table align = "center">
            ...
            <tbody>
                <?php
                    $query = 'SELECT * FROM cyber_foreinsics';
                    $stm = $conn->prepare("select * from cyber_foreinsics");
                    $stm -> execute();
                    while($row = $stm->fetch()){
