...
<div class="log-bar">
    ...
    ?>
     <div class="book_container">
         <div class="img">
            <img src="../Book_Cover/book4.jpg" alt="">
            <a href="../Books/download.php?id=<?php echo $row['id'] + 4;?>">
...
<div class="container">
        <table align = "center">
            ...
            <tbody>
                <?php
                    $query = 'SELECT * FROM identityTheft';
                    $stm = $conn->prepare("select * from identityTheft");
                    $stm -> execute();
                    while($row = $stm->fetch()){
