...
<body>
    ...
    ?>
     <div class="book_container">
         <div class="img">
            <img src="../Book_Cover/book12.jpg" alt="">
            <a href="../Books/download.php?id=<?php echo $row['id'] + 12;?>">
...
<div class="_container">
        <table align = "center">
            ...
            <tbody>
                <?php
                    $query = 'SELECT * FROM inside_threat';
                    $stm = $conn->prepare("select * from inside_threat");
                    $stm -> execute();
                    while($row = $stm->fetch()){
