...
<body>
    ...
    ?>
     <div class="book_container">
         <div class="img">
            <img src="../Book_Cover/book5.jpg" alt="">
            <a href="../Books/download.php?id=<?php echo $row['id'] + 5;?>">
...
<div class="container">
        <table align = "center">
            ...
            <tbody>
                <?php
                    $query = 'SELECT * FROM internetSecurity';
                    $stm = $conn->prepare("select * from internetSecurity");
                    $stm -> execute();
                    while($row = $stm->fetch()){
