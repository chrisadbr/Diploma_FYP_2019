...
<div class="log-bar">
    ...
    ?>
     <div class="book_container">
         <div class="img">
            <img src="../Book_Cover/book10.jpg" alt="">
            <a href="../Books/download.php?id=<?php echo $row['id'] + 10;?>">
...
<div class="_container">
        <table align = "center">
            ...
            <tbody>
                <?php
                    $query = 'SELECT * FROM networkSecurity';
                    $stm = $conn->prepare("select * from networkSecurity");
                    $stm -> execute();
                    while($row = $stm->fetch()){
